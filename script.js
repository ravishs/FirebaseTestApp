$(document).ready(function() {
  ...
  function on_tokenButton_click(e) {
    try {
      ...
      // Block#: ?(/KXla4DiTjklPGzy+M
      com.fc.JavaScriptDistLib.Label.setProperty["Text"]("body", (com.fc.JavaScriptDistLib.TextLib.convertToText(com.fc.JavaScriptDistLib.FireBase.getRefreshedToken())));
      e.stopPropagation();
    } catch(e) {
      com.fc.JavaScriptDistLib.handleExceptionNative(e);
    }
  ...
  function on_deviceIdButton_click(e) {
    try {
      ...
      // Block#: mB7jByK~b6,rAD;sDDAl
      com.fc.JavaScriptDistLib.Label.setProperty["Text"]("body", (com.fc.JavaScriptDistLib.TextLib.convertToText(com.fc.JavaScriptDistLib.FireBase.getUniqueDeviceId())));
      e.stopPropagation();
    } catch(e) {
      com.fc.JavaScriptDistLib.handleExceptionNative(e);
    }
